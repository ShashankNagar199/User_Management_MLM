...
public class ProductSalesService {
    ...
    @Transactional
    public SalesRecord addProductSales(String product,String userId){
        User user= userRepository.findByUserId(userId);
        Double availableBalance=user.getBalance();
        Double amount=customUtils.convertStringToDouble(product);
        ...
        if(user.getReferrer()!=null){
            updateRewardAmountToParentNodes(user.getUserId(),user.getLevel()+1,product);
        }
    ...
    public void updateRewardAmountToParentNodes(String userId,Integer level,String Product){
        ...
        Double userSales=user.getSales()+Double.parseDouble(Product) *rewardPercentage/100;
