...
public class UserService {
	...
	public LoginUserResponse login(LoginUserRequest loginUserRequest) {
		...
		User user = userRepository.findByUserId(loginUserRequest.getEmail());
		final UserDetails userDetails
				= userDetailsService.loadUserByUsername(loginUserRequest.getEmail());
...
//			user.setReferrer(referrerUserId);
			...
			String walletAddress=tronWalletService.callApi(userdto.getUserId());
