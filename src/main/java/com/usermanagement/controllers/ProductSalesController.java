...
public class ProductSalesController {
    ...
    public ResponseEntity<SalesRecord> addProduct(@RequestBody ProductSalesParamsdto productSalesParamsdto) throws Exception {
        return new ResponseEntity<>(productSalesService.addProductSales(productSalesParamsdto.getProduct(),productSalesParamsdto.getAmount(),productSalesParamsdto.getUserId()), HttpStatus.CREATED);
    }
